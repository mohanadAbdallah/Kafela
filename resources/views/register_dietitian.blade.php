                    ...
                    <div class="card-body " style="box-shadow: 0px 5px 10px -5px #6a306d;">
                        ...
                        @if(session()->has('success'))
                            <div class="form-group display-7" style="text-align: center">
                                ...
                                <p style="font-weight:bold;text-align: center;direction: rtl">سيتم مراجعة طلبك , في حال تمت الموافقة
                                </p>
                                <p style="text-align: center;direction: rtl">ستصلك رسالة بريد إلكتروني تحتوي على:
                                </p>
                                <p style="text-align: center;direction: rtl">1- الرقم الرمزي الخاص بك لمشاركته مع مرضاك
                                    لمتابعتهم (إن وجد)
                                </p>
                                <p style="text-align: center;direction: rtl">2- رابط المنصه وبيانات تسجيل الدخول
                                </p>
                                <p style="text-align: center;direction: rtl">شكرا جزيلا لتعاونكم</p>

                            </div>
                        @else
                            <form method="post" action="{{route('register.dietitian.store')}}"
                                ...
                                <br>
                                <div class="form-group display-7" style="text-align: right" dir="rtl">
                                    <label for="exampleFormControlInput3">البريد الالكتروني</label>
                                    <input type="email" name="email" class="form-control email_typing"
                                           id="exampleFormControlInput3"
                                           placeholder="البريد الالكتروني">
                                    <span class="invalid-feedback email-error" role="alert">
                                        <strong>يجب ملئ الحقل</strong>
                                    </span>
                                </div>
                                <br>
                                <div class="form-group display-7" style="text-align: right" dir="rtl">
                                    <label for="exampleFormControlInput4">عدد سنوات الخبرة مع مرضى السكري</label>
                                    <input type="number" name="exp_count" class="form-control exp_count_typing"
                                           id="exampleFormControlInput4"
                                           placeholder="عدد السنوات">
                                    <span class="invalid-feedback exp_count-error" role="alert">
                                        <strong>يجب ملئ الحقل</strong>
                                    </span>
                                </div>
                                <br>
                                <div class="form-group display-7" style="text-align: right" dir="rtl">
                                    <label for="Yes1">هل هناك مرضى تتابع معهم وترغب في تسجيلهم : </label>
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="Yes1" checked value="yes" name="there_patients"
                                               class="custom-control-input">
                                        <label class="custom-control-label" for="Yes1">نعم</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="No1" value="no" name="there_patients"
                                               class="custom-control-input">
                                ...
                                <div class="form-group display-7" style="text-align: right" dir="rtl">
                                    <label for="Yes2">(أذا كانت إجابتك نعم) هل لديك الرغبة في التطوع لمتابعة مرضى
                                        اخرين:</label>
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="Yes2" checked value="yes" name="if_yes"
                                               class="custom-control-input">
                                        <label class="custom-control-label" for="Yes2">نعم</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="No2" value="no" name="if_yes"
                                               class="custom-control-input">
                                ...
                                <br>
                                <div class="form-group display-7" style="text-align: right" dir="rtl">
                                    <label for="exampleFormControlInput5">الرجاء رفع شهادة التخصصات الصحية</label>
                                    <input type="file" name="certificate_file"
                                           class="form-control certificate_file_typing" id="exampleFormControlInput5"
                                    >
                                </div>
                                <br>
                                <div class="form-group display-7" style="text-align: right" dir="rtl">
                                    ...
                                    <label for="exampleFormControlInput6">  أوافق على سياسة خصوصية المرضى <a target="_blank"
                                                href="{{route('our.conditions.dietitian')}}">(سياسة الخصوصية)</a> </label>
                                </div>
                                <br>
                                <div class="form-group display-7" style="text-align: center">
