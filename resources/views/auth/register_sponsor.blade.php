                ...
                <div class="card-body " style="box-shadow: 0px 5px 10px -5px #4caf50;">
                    <div class="card-body ">
                        <div class="mbr-figure pt-0">
                            @if(!isset($fail)) <h4 style="font-family: 'Changa-Regular';color: #4caf50;font-weight: bold;margin-bottom: 30px;margin-top: 30px;
}"> تسجيل اشتراك كافل جديد </h4> @endif

                        </div>
                        <div class="mbr-figure pt-0">
                            @if(isset($phone)) <h6 style="font-family: 'Changa-Regular';color: #ff6851;font-weight: bold;margin-bottom: 30px;margin-top: 30px;
}"> {{$phone}} </h6> @endif
                        ...
                        @if(!isset($fail))
                            ...
                            <form method="POST" action="{{ route('register.sponsor.store') }}" aria-label="{{ __('Login') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group display-7" style="text-align: right" dir="rtl">
                                    ...
                                    <input type="text"
                                           ...
                                           autocomplete="name" autofocus id="exampleFormControlInput1"
                                           placeholder="الإسم">
                                    @error('name')
                                ...
                                <div class="form-group display-7" style="text-align: right" dir="rtl">
                                    <label for="exampleFormControlInput1">رقم الجوال <span style="font-size: small;">(رقم الجوال مكون من 9 ارقام ويبدأ ب 5)</span></label>
                                    <input type="number"
                                           class="form-control  @error('phone') is-invalid @enderror"
                                           name="phone" value="{{ old('phone') }}" max="9" min="9" required
                                           autocomplete="phone" autofocus id="exampleFormControlInput1"
                                ...
                                <div class="form-group display-7" style="text-align: center">
                                    <a href="{{route('login')}}"
                                       style="    background-color: #629de0  !important;border:#629de0 ;padding: 0.5rem 1rem; "
                                       class="btn btn-info">
                                        للخلف
                                    </a>
